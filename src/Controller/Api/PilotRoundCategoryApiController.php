...
class PilotRoundCategoryApiController extends AbstractController
{
    ...
    ): Response
    {
        ...
        return $this->json($pilotRoundCategories, Response::HTTP_OK, [], ['groups' => ['pilotRoundCategory', 'pilotRoundCategoryPilot', 'pilot', 'pilotPerson', 'person', 'pilotRoundCategoryPenalties', 'penalty', 'penalties', 'penaltyPenaltyReason', 'penaltyReason', 'pilotRoundCategoryQualifyings', 'qualifying', 'qualifyingDetails', 'qualifyingDetail', 'qualifyingDetailCriteria', 'qualifyingCriteria']]);
    }

    #[Route('/{pilotRoundCategory}', name: 'detail', methods: ['GET'])]
    public function getPilotRoundCategory(
