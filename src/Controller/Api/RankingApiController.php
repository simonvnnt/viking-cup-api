...
class RankingApiController extends AbstractController
{
    ...
    ): Response
    {
        ...
        return $this->json($rankingPilotRoundCategory, 200, [], ['groups' => ['pilot', 'pilotPerson', 'person', 'round', 'category']]);
    }
    ...
    ): Response
    {
        ...
        return $this->json($rankingPilotEventCategory, 200, [], ['groups' => ['pilot', 'pilotPerson', 'person', 'round', 'category']]);
    }
}