...
class QualifyingApiController extends AbstractController
{
    ...
    ): Response
    {
        ...
        return $this->json($roundCategoryPilotsQualifying, Response::HTTP_OK, [], ['groups' => ['qualifying', 'qualifyingDetails', 'qualifyingDetail', 'qualifyingDetailCriteria', 'qualifyingCriteria', 'pilotRoundCategory', 'pilotRoundCategoryPilot', 'pilot', 'pilotPerson', 'person']]);
    }
    ...
    ): Response
    {
        ...
        return $this->json($qualifyingRanking, 200, [], ['groups' => ['pilot', 'pilotPerson', 'person', 'round', 'category', 'qualifying']]);
    }
